        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComponentManufacturesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_ComponentManufactures_ComponentManufacturesId",
                        column: x => x.ComponentManufacturesId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gaming Pro", 10, "3 lata", 8.5 },
                    { 2, new DateTime(2024, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "WorkStation X", 5, "2 lata", 12.0 },
                    { 3, new DateTime(2024, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Budget Build", 20, "1 rok", 6.5 }
                });

            migrationBuilder.InsertData(
                table: "Components",
                columns: new[] { "Code", "ComponentManufacturesId", "ComponentTypeId", "Description", "Name" },
                values: new object[,]
                {
                    { "DDR5-32GB", 2, 3, null, "DDR5 32GB 6000MHz" },
                    { "I9-14900K", 1, 1, null, "Intel Core i9-14900K" },
                    { "RX7900XTX", 2, 2, null, "AMD Radeon RX 7900 XTX" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Components_ComponentManufacturesId",
                table: "Components",
                column: "ComponentManufacturesId");
